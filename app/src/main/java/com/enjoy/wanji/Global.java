...
public class Global {
    ...
    //加载地图标志符
    public static volatile boolean loadRoadsFlag = true;
    public static volatile boolean deleteRoadFlag = false; //删除地图标志
    static volatile boolean loadRoadsHttpMainPageFlag = false;
    static long loadRoadsFlagTimestamp = System.currentTimeMillis();
    static volatile boolean loadRoadsHttpCollectPageFlag = false;
    ...
    public static volatile int connectTip = 0;   //1--连接成功  2--连接断开
